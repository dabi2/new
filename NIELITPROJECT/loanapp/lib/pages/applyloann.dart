                ...
                children: <Widget>[
                  ...
                  TextButton(
                    style: ButtonStyle(
                        ...
                        backgroundColor:
                            MaterialStatePropertyAll(MainColors.lightcontainer)),
              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: [
                      Text.rich(TextSpan(
                        text: "Get Instant",style: GoogleFonts.merriweather(
                        )
                      ),),
                      Text.rich(TextSpan(
                        text: " LOAN",style: GoogleFonts.merriweather(
                          fontWeight: FontWeight.bold,
                          fontSize: 16,
                        )
                      )),
                      Text.rich(TextSpan(
                        text: " With just One Click ",style: GoogleFonts.merriweather()
                      )),
                      Icon(Icons.clean_hands,color: MainColors.containercolor,),
                    ],
                  ),
                  Divider(
                    color: MainColors.containercolor,
                      ...
                      Container(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(onPressed: (){}, style: ButtonStyle(
                              ...
                              backgroundColor:
                                  MaterialStatePropertyAll(MainColors.lightcontainer)), icon: Icon(Icons.monetization_on_outlined,color: Colors.white,), label: Text("Apply Now",style: TextStyle(color: Colors.white),)),
                      ...
                      Container(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(onPressed: (){}, style: ButtonStyle(
                              ...
                              backgroundColor:
                                  MaterialStatePropertyAll(MainColors.lightcontainer)), icon: Icon(Icons.monetization_on_outlined,color: Color.fromARGB(255, 255, 255, 255),), label: Text("Apply Now",style: TextStyle(color: const Color.fromARGB(255, 255, 255, 255),),)),                            
                        ],
                      ), 
                      ),
