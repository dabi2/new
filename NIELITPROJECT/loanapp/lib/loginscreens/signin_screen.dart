...
class _SignInScreenState extends State<SignInScreen> {
    ...
    return Scaffold(
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              Image.asset("images/loginimage.png",height: 300,width: 200,),
              SizedBox(
                height: 20,
              ),
              reusableTextField("Enter Username", Icons.person_2, false, _emailTextController),
              SizedBox(
                height: 20,
              ),
  ...
  Row signUpOption(){
    return Row(
      ...
      children: [
        Text("Don't have Account?",style: GoogleFonts.merriweather(color:Colors.white),),
        GestureDetector(
          onTap: (){
            Navigator.push(context,MaterialPageRoute(builder: (context) => SignupScreen()));
          },
          child: Text(" SIGN UP",style: GoogleFonts.merriweather(color:Colors.white,fontWeight:FontWeight.bold),),
        )
      ],
    );
  }
