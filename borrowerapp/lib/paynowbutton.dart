              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Padding(
                      padding: EdgeInsets.only(top: 20,left: 100,right: 50,bottom:10 ,),
                      child: Row(
                        children: [
                          Column(
                            children: [
                              Text('Secure Payment',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),),
                              Row(
                                children: [
                                  Text('Pay with Your Trust',style: TextStyle(color: Colors.white,),)
                                ],
                              )
                            ],
                          ),
                ...
                Column(
                  children: [
                    Container(
                        ...
                        const Text('Net Banking',style: TextStyle(color: Colors.white,fontSize: 16,),)
                  ],
                ),
                Column(
                  children: [
                    Container(
                        ...
                        const Text('Debit/Credit Cards',style: TextStyle(color: Colors.white,fontSize: 16,),)
                  ],
                ),
              ],
            ),
                ...
                Column(
                  children: [
                    Container(
                        ...
                        const Text('Phone Pe',style: TextStyle(color: Colors.white,fontSize: 16,),)
                  ],
                ),
                Column(
                  children: <Widget> [
                    Container(
                      ...
                      const Text('UPI',style: TextStyle(color: Colors.white,fontSize: 16,),)
                  ],
                )
              ],
            ),
